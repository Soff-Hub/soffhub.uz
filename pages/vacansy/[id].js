        ...
        {data && (
          <div className="container">
            <div className="row">
              ...
              <div
                className="col-12 pl-30 d-flex g-2 text-base mb-5 mt-5 align-items-center"
                style={{ gap: "10px" }}
              >
                <i className="fa-solid fa-calendar-day fa-beat-fade align-items-center"></i>
                <span>{data.from_day}</span> -<span>{data.to_day}</span>
              </div>

              <div className="col-12 pl-30 text-base mb-5 g-2 d-flex">
                <i className="fa-solid fa-clock fa-beat-fade me-2 ms-0"></i>
                <span>{data.start_time}</span> -<span>{data.end_time}</span>
              </div>
              <div className="col-12 text-base pl-30 mb-5 d-flex align-content-center g-2">
              ...
              <div className="col-12 my-2  d-flex justify-content-end">
                <div
                  ...
                  className="view-more-vacansy-btn ariza-btn"
                >
                  <ModalAntd title={data.title} id={data.id} />
                </div>
              </div>
            </div>
          </div>
